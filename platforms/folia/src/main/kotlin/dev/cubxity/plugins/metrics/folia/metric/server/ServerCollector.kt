...
package dev.cubxity.plugins.metrics.folia.metric.server
...
/**
 * Reads server-global state (onlinePlayers, maxPlayers, plugins) which is
 * safe to access from any thread in Folia. No region-owned data is accessed.
 */
class ServerCollector(private val bootstrap: UnifiedMetricsFoliaBootstrap) : Collector {
